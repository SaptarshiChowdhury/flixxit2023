      ...
      if (userId != "") {
        ...
        User.findById(userId).then(user => {
          ...
          for (let i of content) {
            let ind = wishlist.indexOf(i._id)
          ...
          res.json({
            content: content, wishlist: res_wishlist,
...
app.post('/content', (req, res) => {
  let { poster, title, rating, genre, releaseDate,
    description, cast, videoUrl, intro_skip } = req.body;
