...
export default function PayCard() {
        ...
        if (cur == 0) {
            return <>
                ...
                <Box sx={{ fontSize: '1.5vh', mt: '0.6vh' }}>
                    <TextField className='textfeild' defaultValue={'Joshua Alex'} sx={{
                        'input': {
                ...
                <Box sx={{ fontSize: '1.5vh', mt: '0.6vh' }}>
                    <TextField className='textfeild' defaultValue={'2220-XXXX-XXXX-0906'} sx={{
                        'input': {
                            fontSize: '1.6vh !important',
                            p: '1.3vh 2vh'
                        }
    ...
    const id = localStorage.getItem('userdet') && JSON.parse(localStorage.getItem('userdet'))._id
    const initializePayment = async () => {
        console.log('payment initialized')
        showLoader()
        setTimeout(async () => {
            await axios.put(process.env.REACT_APP_BACKEND_URL + '/users/' + id + '/subscription').then(res => {
    ...
    return (
        <Box className='flexcenter' id='paymentCard' sx={{ zIndex: '10', backgroundColor: '#a4a4cb75', position: 'absolute', height: '100vh', width: '100vw' }}>
            <Box sx={{ position: 'fixed', display: 'none' }}><input id='useMeAsVessel'></input></Box>
            <Box sx={{ width: '60vw', backgroundColor: 'white', borderRadius: '5px' }}>
                <Box sx={{
                    display: 'flex', justifyContent: 'space-between'
                }}>
                    <Box sx={{ width: '100%', p: '4.5vh 5.6vh', borderRadius: '5px 0 0 5px' }}>
                        <Box sx={{ fontSize: '2.6vh', color: '#090D28', fontWeight: '600' }}>Add Card<br /><Box style={{ fontSize: '1.6vh', color: 'red' }}>Do not enter your details, please click on "continue payment"</Box></Box>
                        ...
                        <Box sx={{ display: 'flex', gap: '16px', mt: '1vh' }}>
                            <Box
                                ...
                                sx={{ cursor: 'pointer', width: '100%', border: `1px solid ${cur == 0 ? 'var(--highlight-color)' : '#C2C2C2'}`, p: '1.5vh', borderRadius: '5px', display: 'flex', }}>
                                <svg style={{ width: '100%' }} width="81" height="15" viewBox="0 0 81 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M68.5337 11.0174H66.7516L67.8663 4.125H69.6483L68.5337 11.0174Z" fill="#00579F" />
                                    <path d="M74.9936 4.29344C74.6421 4.15398 74.0846 4 73.3952 4C71.6352 4 70.3959 4.93849 70.3883 6.28024C70.3737 7.27019 71.2756 7.82003 71.9502 8.15011C72.6397 8.4874 72.8741 8.70755 72.8741 9.0082C72.8671 9.46994 72.3169 9.68278 71.8038 9.68278C71.0923 9.68278 70.7111 9.57304 70.1317 9.31615L69.897 9.20603L69.6476 10.7532C70.0656 10.9436 70.8357 11.1126 71.6352 11.12C73.5052 11.12 74.7226 10.1961 74.737 8.76622C74.7441 7.98161 74.2679 7.38041 73.2411 6.88914C72.6178 6.57378 72.236 6.36113 72.236 6.03846C72.2433 5.74512 72.5589 5.44467 73.2625 5.44467C73.8419 5.42995 74.2676 5.56922 74.5901 5.70858L74.7512 5.78176L74.9936 4.29344Z" fill="#00579F" />
                                    <path d="M77.3624 8.57566C77.5092 8.1797 78.074 6.64722 78.074 6.64722C78.0666 6.66194 78.2204 6.24396 78.3084 5.98736L78.433 6.58125C78.433 6.58125 78.7705 8.23106 78.8438 8.57566C78.5652 8.57566 77.7145 8.57566 77.3624 8.57566ZM79.5623 4.125H78.1838C77.7587 4.125 77.4357 4.24955 77.2523 4.69686L74.6052 11.0173H76.4751C76.4751 11.0173 76.783 10.1666 76.8492 9.98339C77.0543 9.98339 78.8734 9.98339 79.1373 9.98339C79.1885 10.2254 79.3499 11.0173 79.3499 11.0173H81L79.5623 4.125Z" fill="#00579F" />
                                    <path d="M65.2627 4.125L63.5173 8.82495L63.3266 7.87174C63.0039 6.77187 61.992 5.57688 60.8627 4.9827L62.4613 11.0101H64.3459L67.1471 4.125H65.2627Z" fill="#00579F" />
                                    <path d="M61.8966 4.125H59.0293L59 4.26426C61.2367 4.83622 62.718 6.21492 63.3266 7.87203L62.7033 4.70437C62.6007 4.26417 62.2853 4.13952 61.8966 4.125Z" fill="#FAA61A" />
                                    <path d="M47.0616 3.37109H42.9279V10.7994H47.0616V3.37109Z" fill="#FF5F00" />
